ApplicationRouter = Backbone.Marionette.AppRouter.extend({
	...
	panel: function () {
		this.selectPill('ul.sidebar li.panel');
		MyApp.contentRegion.show(new ContentPanelView());
	},
	...
	eventposter: function () {
		this.selectPill('ul.sidebar li.eventposter');
		MyApp.contentRegion.show(new ContentEventPosterView());
	},
