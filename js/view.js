...
ContentRegistrationView = Backbone.View.extend({
	initialize: function (options) {
	},
	render: function (options) {
		var template = _.template($("#template_content_registration").html(), {});
		this.$el.html(template);
	}
});

ContentSubmissionView = Backbone.View.extend({
	initialize: function (options) {
	},
	render: function (options) {
		var template = _.template($("#template_content_submission").html(), {});
		this.$el.html(template);
	}
});
